...
// import { AuditAction, AuditEntityType } from '@/services/api/audit.api.ts';
...
//    */
//   flagSuspiciousActivities(logs: any[]) {
//     const suspicious = [];
