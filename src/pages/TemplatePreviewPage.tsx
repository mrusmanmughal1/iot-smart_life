...
export default function TemplatePreviewPage() {
  ...
  const wasteCollectionData = [
    ...
    {
      name: t('solutionTemplates.templatePreview.chartLabels.remaining'),
      value: 32,
    },
  ];
  ...
  const roadTrafficData = [
    {
      name: t('solutionTemplates.templatePreview.chartLabels.active'),
      value: 78,
    },
    {
      name: t('solutionTemplates.templatePreview.chartLabels.free'),
      value: 22,
    },
  ];
