...
const alertHistory = [
  {
    message: 'High Temperature Alert - 28.5°C exceeded threshold',
    time: '2 hours ago',
    color: 'bg-blue-600',
  },
  {
    message: 'Medium Temperature Alert - 27.8°C approaching threshold',
    time: '2 hours ago',
    color: 'bg-pink-400',
  },
  {
    message: 'Connection Lost - Device went offline',
    time: '2 hours ago',
    color: 'bg-indigo-800',
  },
];
    ...
    <div className="flex flex-col space-y-6 animate-in fade-in duration-500 pb-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <PageHeader
          ...
          description={t('analytics.deviceDetails.subtitle', {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="border-gray-200 shadow-sm bg-primary text-white">
          <CardContent className="p-6">
            <h3 className="text-sm font-semibold   uppercase">
              {t('analytics.deviceDetails.stats.currentStatus')}
            </h3>
            <p className="text-xl font-semibold text-white mt-1">ONLINE</p>
            <p className="text-xs   mt-1">
              {t('analytics.deviceDetails.stats.lastSeen', {
                time: '2 min ago',
              })}
            </p>
          </CardContent>
        ...
        <Card className="border-gray-200 shadow-sm bg-secondary text-white">
          <CardContent className="p-6">
            <h3 className="text-sm font-semibold   uppercase">
              {t('analytics.deviceDetails.stats.dataRate')}
            </h3>
            <p className="text-xl font-semibold text-white mt-1">2.3 MB/day</p>
            <p className="text-xs  mt-1">↑ 15% from yesterday</p>
          </CardContent>
        </Card>

        <Card className="border-gray-200 shadow-sm bg-success text-white">
          <CardContent className="p-6">
            <h3 className="text-sm font-semibold   uppercase">
              {t('analytics.deviceDetails.stats.uptime')}
            </h3>
            <p className="text-xl font-semibold text-white mt-1">99.8%</p>
            <p className="text-xs  mt-1">
              {t('analytics.deviceDetails.stats.last30Days')}
            </p>
          </CardContent>
        </Card>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="border-gray-200 shadow-sm rounded-xl overflow-hidden">
          <CardHeader className="p-6 pb-2">
            <CardTitle className="text-xl font-semibold text-gray-800">
              {t('analytics.deviceDetails.charts.readings', {
                type: 'Temperature',
              })}
            </CardTitle>
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center text-sm">
                <span className="text-gray-500">
                  {t('analytics.deviceDetails.info.deviceId')}:
                </span>
              ...
              <div className="flex justify-between items-center text-sm">
                <span className="text-gray-500">
                  {t('analytics.deviceDetails.info.location')}:
                </span>
              ...
              <div className="flex justify-between items-center text-sm">
                <span className="text-gray-500">
                  {t('analytics.deviceDetails.info.firmware')}:
                </span>
                <span className="font-medium text-gray-800">
              ...
              <div className="flex justify-between items-center text-sm">
                <span className="text-gray-500">
                  {t('analytics.deviceDetails.info.battery')}:
                </span>
                <span className="font-medium text-gray-800">
              ...
              <div className="flex justify-between items-center text-sm">
                <span className="text-gray-500">
                  {t('analytics.deviceDetails.info.signalStrength')}:
                </span>
                <span className="font-medium text-gray-800">
                  {deviceDetails.signalStrength}
                </span>
              </div>
            </div>
