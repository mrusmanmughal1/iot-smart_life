...
export default function RequestAnalyticsPage() {
    ...
    const columns = [
        createSortableColumn('endpoint', 'Endpoint'),
        {
            ...
            header: 'Requests',
            cell: ({ row }: any) => (
                <span className="font-semibold">{row.getValue('requests').toLocaleString()}</span>
            ),
        },
        {
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-3 items-center">
                ...
                <Select value={endpoint} onValueChange={setEndpoint}>
                    ...
                    <SelectContent>
                        ...
                        <SelectItem value="/api/v1/attributes">/api/v1/attributes</SelectItem>
                    </SelectContent>
                </Select>
            ...
            <div className="grid gap-6 lg:grid-cols-4">
                {metricCards.map((card) => (
                    <Card key={card.title} className={`border-none shadow-sm ${card.bgColor}`}>
                        ...
                        <div className="h-[300px] w-full">
                            <ResponsiveContainer width="100%" height="100%">
                                <BarChart data={volumeData}>
                                    ...
                                    <Tooltip />
                                    <Legend />
                                    <Bar dataKey="requests" fill="#4338ca" radius={[4, 4, 0, 0]} />
            ...
            <Card className="border border-gray-100 shadow-sm">
                ...
                <CardContent className="overflow-hidden">
                    <DataTable columns={columns} data={requestEndpoints} searchKey="endpoint" />
                </CardContent>
            </Card>
        </div>
    );
