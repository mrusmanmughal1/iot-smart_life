    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center gap-2 text-sm text-muted-foreground">
        ...
        <span className="text-xs dark:text-gray-400">
          Last update:{' '}
          {realtimeActivities[0]
            ? formatRelativeTime(realtimeActivities[0].timestamp)
            : 'Waiting...'}
        </span>
      </div>
          ...
          <CardContent>
            <div className="flex items-end justify-between">
              <div>
                ...
                <Button
                  variant="link"
                  className="p-0 h-auto text-purple-600 dark:text-purple-400 text-xs mt-1"
                >
                  View All
                </Button>
              </div>
          ...
          <CardContent className="space-y-3">
            {[
              ...
              >
                ...
                <span
                  className={`px-2 py-1 text-xs text-white rounded ${t.color}`}
                >
                  {t.label}
                </span>
              </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6">
          {[
            ...
            },
            {
              ...
              gradient:
                'from-gray-100 to-[#C5C5C5] text-gray-900 dark:from-gray-700 dark:to-gray-600 dark:text-white',
            },
            {
              title: 'Dashboard Preview',
